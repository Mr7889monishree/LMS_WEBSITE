...
const CourseDetails = () => {
  ...
  // Toggle chapter sections
  const toggleSection = index => {
    setOpenSection(prev => ({ ...prev, [index]: !prev[index] }));
  };

  // Helper: safely extract YouTube video ID
    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>
            Course by <span className='text-blue-600 underline'>{courseData.educatorId.name}</span>
          </p>
                    ...
                    <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className='flex items-start gap-2 py-1'>
                          ...
                          <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default gap-3'>
                              ...
                              {lecture.isPreviewFree && (
                                <p
                                  onClick={() => {
                                    ...
                                    else toast.error('Invalid YouTube URL for preview');
                                  }}
        ...
        {/* Right column */}
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[400px] mx-auto'>
